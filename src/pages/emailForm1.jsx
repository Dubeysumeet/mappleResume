  ...
  return (
    <div className="flex justify-center items-center h-full py-10">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md transition-transform transform hover:scale-105 duration-300">
        {!submitted ? (
          <>
            <h2 className="text-3xl font-extrabold text-center mb-6 text-blue-600 animate-fadeIn">Resume Review Request</h2>
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                  required
                />
              </div>
              <div className="mb-4">
              ...
              <button
                type="submit"
                className={`w-full py-2 px-4 rounded-lg text-white font-bold flex items-center justify-center ${
...
export default ResumeReviewForm1;
