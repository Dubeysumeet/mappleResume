    ...
    <Accordion type="single" collapsible>
        <AccordionItem value="item-1" className="mb-2">
            <AccordionTrigger className="text-2xl text-black border p-6">
              ...
              <AccordionContent className="bg-blue-950 text-white text-base font-normal p-6">
              <p>
            ...
            <AccordionContent className="bg-blue-950 text-lg text-white  p-6 flex flex-wrap">
              ...
              <div className="flex justify-between flex-wrap">
                ...
                <div className="flex flex-col w-1/2 p-4">
                  <p> <span className='mr-3'> <CheckRoundedIcon className="text-green-600 border-2 rounded-full border-green-600"/></span>90-Day Interview Guarantee</p>
                </div>

                <div className="flex flex-col w-1/2 p-4">
                  <p> <span className='mr-3'> <CheckRoundedIcon className="text-green-600 border-2 rounded-full border-green-600"/></span>3 Business Day Turnaround</p>
                </div>

                <div className="flex flex-col w-1/2 p-4">
                  <p> <span className='mr-3'> <CheckRoundedIcon className="text-green-600 border-2 rounded-full border-green-600"/></span>100% Satifsaction Guarantee</p>
                </div>

            
              </div>
              <Button className="mt-5 w-auto text-lg px-6 bg-green-600 hover:bg-green-700 text-white rounded-md" onClick={handleFreeResumeReview}>
