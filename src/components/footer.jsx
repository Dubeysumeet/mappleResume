...
const Footer = () => {
  ...
  return (
    ...
    <div className="footer-section-2 flex flex-wrap justify-center md:justify-between items-center md:items-start text-center md:text-left py-10 border-b border-gray-700">
      ...
      <div className="footer-section-1 flex flex-col items-center md:items-start mb-8 md:mb-0">
        <a href="/">
          <img className="w-52" src={logo} alt="Mapple Resume logo" />
        </a>
      </div>
      <div className="social-icons flex flex-col items-center md:items-start">
